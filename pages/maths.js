...
<>
    ...
    <h1>Maths Training</h1>       
      ...
      <Link href="/measure" legacyBehavior><div className="subjectCard">Measure</div></Link>
    {/*<!--  <Link href="/value" legacyBehavior><div className="subjectCard">Comparing Values</div></Link> -->*/}
